...
const phraseMessages: Record<string, string> = {
  ...
  ["入力してください"]: "Vui lòng nhập",
  ["選択または入力"]: "Chọn hoặc nhập",
  ["選択または入力してください"]: "Vui lòng chọn hoặc nhập",
  ["検索して選択"]: "Tìm và chọn",
  ["値を入力"]: "Nhập giá trị",
  ["数値で入力してください"]: "Vui lòng nhập bằng số",
  ["0以上で入力してください"]: "Vui lòng nhập số từ 0 trở lên",
  ["最小"]: "Tối thiểu",
  ["最大"]: "Tối đa",
  ...
  ["発注済み"]: "Đã đặt hàng",
  ["支払い済み"]: "Đã thanh toán",
  ["支払い履歴"]: "Lịch sử thanh toán",
  ["支払いを追加"]: "Thêm thanh toán",
  ["支払い #"]: "Thanh toán #",
  ["支払金額"]: "Số tiền thanh toán",
  ["支払済み額"]: "Số tiền đã thanh toán",
  ["残額"]: "Số tiền còn lại",
  ["支払いを登録すると、合計金額に達した時点で「支払い済み」が自動的にチェックされます。"]:
    "Khi đăng ký thanh toán, ô「Đã thanh toán」sẽ được tự động đánh dấu khi đạt đến tổng số tiền.",
  ["（支払い履歴から自動制御）"]: "(Tự động kiểm soát từ lịch sử thanh toán)",
  ["仕入先発行のPO番号を入力してください"]: "Vui lòng nhập số PO do nhà cung cấp phát hành",
  ["支払日を入力してください"]: "Vui lòng nhập ngày thanh toán",
  ["金額を入力してください"]: "Vui lòng nhập số tiền",
  ["0より大きい値を入力してください"]: "Vui lòng nhập giá trị lớn hơn 0",
  // 標準カテゴリ（シードデータ・支払い管理スタイル定義に存在する一般的な会計区分）
  ["経費"]: "Chi phí chung",
  ["人件費"]: "Chi phí nhân sự",
  ["材料費"]: "Chi phí vật liệu",
  ["外注費"]: "Chi phí thuê ngoài",
  // 標準内容（家賃・光熱費等の一般的な経費項目とシードデータの内容）
  ["家賃"]: "Tiền thuê nhà",
  ["光熱費"]: "Tiền điện nước",
  ["通信費"]: "Cước viễn thông",
  ["保険"]: "Bảo hiểm",
  ...
  ["給与"]: "Lương",
  ["賞与"]: "Tiền thưởng",
  ["原材料購入（変動）"]: "Mua nguyên liệu (biến động)",
  // 標準支払方法（システムデフォルト値）
  ["銀行振込"]: "Chuyển khoản ngân hàng",
  ["口座振替"]: "Trích nợ tự động",
  ["現金"]: "Tiền mặt",
  ...
  ["入力内容をご確認ください。"]: "Vui lòng kiểm tra lại nội dung đã nhập.",
